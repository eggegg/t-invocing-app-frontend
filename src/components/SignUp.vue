                ...
                <div class="col-md-12">
                    <form @submit.prevent="login">
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" placeholder="username" v-model="model.username">
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <form @submit.prevent="register">
                        <div class="form-group">
                            <label for="">UserName:</label>
                            <input type="text" required class="form-control" placeholder="eg Chris" v-model="model.username">
                        </div>
